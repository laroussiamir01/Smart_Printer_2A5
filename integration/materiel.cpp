...
stat_combo_mat::stat_combo_mat(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::stat_combo_mat)
{
    ui->setupUi(this);
}

stat_combo_mat::~stat_combo_mat()
{
    delete ui;
}
...
//bar chart
void stat_combo_mat::choix_bar_mat()
{
QSqlQuery q1,q2,q3;
...
chartView_mat = new QChartView(chart,ui->label_stat_mat);
chartView_mat->setRenderHint(QPainter::Antialiasing);
chartView_mat->setMinimumSize(500,500);

chartView_mat->show();
}

//pie chart
    void stat_combo_mat::choix_pie_mat()
    {
    QSqlQuery q1,q2,q3;
    qreal tot=0,c1=0,c2=0;
