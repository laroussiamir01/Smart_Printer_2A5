...
QSqlQueryModel* Commande::afficher_com()
{
...
bool Commande::supprimer_com(int id)
{
 QSqlQuery query;
...
bool Commande::modifier_com(int id)
{
...
stat_combo_com::stat_combo_com(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::stat_combo_com)
{
    ui->setupUi(this);
}

stat_combo_com::~stat_combo_com()
{
    delete ui;
}
...
//bar chart
void stat_combo_com::choix_bar_com()
{
...
chartView_com = new QChartView(chart,ui->label_stat_com);
chartView_com->setRenderHint(QPainter::Antialiasing);
chartView_com->setMinimumSize(400,400);

chartView_com->show();
}

//pie chart
    void stat_combo_com::choix_pie_com()
    {
    QSqlQuery q1,q2,q3,q4;
    qreal tot=0,c1=0,c2=0,c3=0;
