...
{ QSqlQuery query;
  ...
  stat_combo_perso::stat_combo_perso(QWidget *parent) :
      QDialog(parent),
      ui(new Ui::stat_combo_perso)
  {
      ui->setupUi(this);
  }

  stat_combo_perso::~stat_combo_perso()
  {
      delete ui;
  }
  ...
  //bar chart
  void stat_combo_perso::choix_bar_perso()
  {
  QSqlQuery q1,q2,q3;
  ...
  chartView_perso = new QChartView(chart,ui->label_stat_perso);
  chartView_perso->setRenderHint(QPainter::Antialiasing);
  chartView_perso->setMinimumSize(400,400);

  chartView_perso->show();
  }

  //pie chart
      void stat_combo_perso::choix_pie_perso()
      {
      QSqlQuery q1,q2,q3;
      qreal tot=0,c1=0,c2=0;
